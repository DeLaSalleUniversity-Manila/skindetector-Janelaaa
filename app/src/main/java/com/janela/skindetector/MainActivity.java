package com.janela.skindetector;
...
public class MainActivity extends Activity implements TextureView.SurfaceTextureListener, Camera.PreviewCallback {
    ...
    private RangeSeekBar<Integer> URangeSeekBar, VRangeSeekBar;
    private int lowThreshU, highThreshU, lowThreshV, highThreshV;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* Set-up U range seek bar*/
        URangeSeekBar = (RangeSeekBar) findViewById(R.id.uRangeSeekBar);
        URangeSeekBar.setTextAboveThumbsColorResource(android.R.color.holo_blue_bright);
        URangeSeekBar.setSelectedMinValue(80);
        URangeSeekBar.setSelectedMaxValue(130);

            /* Set-up U range seek bar*/
        VRangeSeekBar = (RangeSeekBar) findViewById(R.id.vRangeSeekBar);
        VRangeSeekBar.setTextAboveThumbsColorResource(android.R.color.holo_blue_bright);
        VRangeSeekBar.setSelectedMinValue(136);
        VRangeSeekBar.setSelectedMaxValue(200);
    ...
    public native void process(Bitmap pTarget, byte[] pSource, int lowThreshU, int highThreshU, int lowThreshV, int highThreshV);
    ...
    private Runnable DoImageProcessing = new Runnable() {
        public void run() {
            ...
            lowThreshU  = URangeSeekBar.getSelectedMinValue();
            highThreshU = URangeSeekBar.getSelectedMaxValue();
            lowThreshV  = VRangeSeekBar.getSelectedMinValue();
            highThreshV = VRangeSeekBar.getSelectedMaxValue();

            process(imageA, videoSource, lowThreshU, highThreshU, lowThreshV, highThreshV);
            imViewA.invalidate();
